...
public class Item extends JButton {
    ...
    private final Color mainColor = SystemColor.BLACK;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!mainMenu) {
            ...
            if (isSelected()) {
                Graphics2D g2 = (Graphics2D) g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
                g2.setPaint(new GradientPaint(0, 3, SystemColor.DARK_GRAY, 3, getHeight() - 6, SystemColor.BLACK));
    ...
    public void setGoogleIcon(GoogleMaterialDesignIcon icon) {
        if (icon != null) {
            this.icon = icon;
            setIcon(new GoogleMaterialIcon(icon, GradientType.HORIZONTAL, SystemColor.DARK_GRAY, SystemColor.BLACK, 19).toIcon());
        }
    }
